    ...
    for word in contents:
      if word.upper() in wordsToBlock:
        ...
        if "444869791329681417" not in [role.id for role in message.author.roles]:
          ...
          emb4.add_field(name="Pre-Warning - <@%s>" % (message.author.id), value="<@%s> has been given a Pre-Warning. You should take this whenever you feel it is okay. To remove this punishment, please do `?remove pre-warn @user` in <#446056722763874335>." % (message.author.id), inline=False)
          ...
          await client.add_roles(message.author, prewarning) 
           ...
           emb4 = (discord.Embed(description=None, colour=0xFF0000))
           emb4.add_field(name="Warning 1 - <@%s>" % (message.author.id), value="<@%s> has been given a warning. They now are on Warning 1. You should take this whenever you feel it is okay. To remove this punishment, please do `?remove warn @user` in <#446056722763874335>." % (message.author.id), inline=False)
           await client.send_message(punishlogs, embed=emb4)
           emb5 = (discord.Embed(description=None, colour=0xFF0000))
           emb5.add_field(name="Muted - <@%s>" % (message.author.id), value="<@%s> has been muted. You should take this whenever you feel it is okay. To remove this punishment, please do `?unmute @user` anywhere." % (message.author.id), inline=False)
           ...
           emb4 = (discord.Embed(description=None, colour=0xFF0000))
           emb4.add_field(name="Warning 2 - <@%s>" % (message.author.id), value="<@%s> has been given a warning. They now are on Warning 2. You should take this whenever you feel it is okay. To remove this punishment, please do `?remove warn @user` in <#446056722763874335>." % (message.author.id), inline=False)
           await client.send_message(punishlogs, embed=emb4)
           emb5 = (discord.Embed(description=None, colour=0xFF0000))
           emb5.add_field(name="Muted - <@%s>" % (message.author.id), value="<@%s> has been muted. You should take this whenever you feel it is okay. To remove this punishment, please do `?unmute @user` anywhere." % (message.author.id), inline=False)
           await client.send_message(punishlogs, embed=emb5)
           ...
           emb4 = (discord.Embed(description=None, colour=0xFF0000))
           emb4.add_field(name="Warning 3 - <@%s>" % (message.author.id), value="<@%s> has been given a warning. They now are on Warning 3. You should take this whenever you feel it is okay. To remove this punishment, please do `?remove warn @user` in <#446056722763874335>." % (message.author.id), inline=False)
           await client.send_message(punishlogs, embed=emb4)
           emb5 = (discord.Embed(description=None, colour=0xFF0000))
           emb5.add_field(name="Muted - <@%s>" % (message.author.id), value="<@%s> has been muted. You should take this whenever you feel it is okay. To remove this punishment, please do `?unmute @user` anywhere." % (message.author.id), inline=False)
           await client.send_message(punishlogs, embed=emb5)
